...
class XFormersImpl(AttentionImpl[XFormersMetadata]):
    ...
    def __init__(
        ...
        self.num_heads_per_shard = self.num_heads // current_num_shards
        self.num_kv_heads_per_shard = self.num_kv_heads // current_num_shards
    ...
    def forward(
        ...
        if kv_cache is not None:
            key_cache, value_cache = liquid_split_kv_cache(
