...
def main():
    ...
    shards_weights = llm.llm_engine.model_executor.get_shards_weights(shard_ids=[2,3])
    cpu_shards_weights = {}
    ...
    llm.llm_engine.model_executor.delete_shards_weights(shard_ids=[2,3])
    ...
    llm.llm_engine.model_executor.append_shards_weights(shard_ids=[2,3], shards_weights=received_shards_weights)
